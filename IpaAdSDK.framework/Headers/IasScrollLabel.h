...
typedef NS_ENUM(NSUInteger, IasScrollLabelAlignment) {
    IasScrollLabelAlignmentLeft = 0,
    IasScrollLabelAlignmentCenter,
    IasScrollLabelAlignmentRight
};
 ...
 */
@interface IasScrollLabel : UIView
...
@property (nonatomic, assign) IasScrollLabelAlignment labelAlignment;     //当文字长度未超过Frame宽度时的对齐方式：左，中，右。默认为居中对齐。
